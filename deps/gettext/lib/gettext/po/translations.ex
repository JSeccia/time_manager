defmodule Gettext.PO.Translations do
  ...
  ## Examples
      ...
      iex> t = %Gettext.PO.Translation{msgid: "foo", flags: MapSet.new(["elixir-autogen"])}
  ...
  def autogenerated?(%module{flags: flags} = _translation) when is_translation(module) do
    # TODO: Remove `elixir-format` to detect autogenerated translations in future releases
    MapSet.member?(flags, "elixir-autogen") or MapSet.member?(flags, "elixir-format")
  end
